...
function twentythirteen_setup() {
	...
	set_post_thumbnail_size( 1024, 640, true );
...
function twentythirteen_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		<h1>Ez is érdekes lehet:</h1>
		<div class="nav-links">

			<?php previous_post_link( '%link', '%title' ); ?><?php if(get_previous_post() != '' && get_next_post()!='') echo ', ';?><?php next_post_link( '%link', '%title' ); ?>
...
<?php endif; ?>
		...
		<div class="reply">
		<?php comment_reply_link(array_merge( $args, array('add_below' => $add_below, 'depth' => $depth, 'max_depth' => $args['max_depth'], 'reply_text' => 'Válasz erre'))) ?>
		</div>
		<?php if ( 'div' != $args['style'] ) : ?>
		</div>
		<?php endif; ?>
