...
export function renderMath(token: Token, markdownIt: MarkdownIt) {
    return <Math dangerouslySetInnerHTML={{ __html:  markdownIt.renderer.renderInline([token], {}, {}) }} />;
}

const Math = styled.span`
    @font-face {
